<div class="page-inner">
    <div class="row">
                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3 text-capitalize"></i>tempat ibadah</span>
                        </a>
        ...
        <div class="col-md-12">
            <livewire:table.tempat-ibadah-table />
        </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-capitalize" id="my-modal-title">
                            {{$update_mode ? 'Update' : 'Tambah'}} tempat ibadah</h5>
                    </div>
                    <div class="modal-body">
                        <x-text-field type="text" name="tempat_ibadah_nama" label="Tempat Ibadah" />
                        <x-textarea type="textarea" name="tempat_ibadah_alamat" label="Alamat" />
                    </div>
