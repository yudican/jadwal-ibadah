                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3 text-capitalize"></i>petugas</span>
                        </a>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-capitalize" id="my-modal-title">
                            {{$update_mode ? 'Update' : 'Tambah'}} petugas</h5>
                    </div>
                    <div class="modal-body">
                        <x-text-field type="text" name="petugas_nama" label="Nama Petugas" />
                        <x-text-field type="number" name="petugas_telepon" label="Telepon Petugas" />
                        <x-textarea type="textarea" name="petugas_alamat" label="Alamat Petugas" />
                    </div>
