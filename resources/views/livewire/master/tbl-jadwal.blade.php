                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3 text-capitalize"></i>jadwal</span>
                        </a>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-capitalize" id="my-modal-title">
                            {{$update_mode ? 'Update' : 'Tambah'}} jadwal</h5>
                    </div>
                    <div class="modal-body">
                        <x-text-field type="text" name="jadwal_nama" label="Jadwal Nama" />
                        <x-input-photo foto="{{$jadwal_logo}}" path="{{optional($jadwal_logo_path)->temporaryUrl()}}"
                            name="jadwal_logo_path" label="Jadwal Icon" />
                    </div>
